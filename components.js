...
export function renderNavbar(user = null) {
    ...
    nav.className = "bg-white/80 backdrop-blur-xl sticky top-0 z-[60] border-b border-slate-200/50 no-print shadow-sm";
    nav.innerHTML = `
        <div class="container mx-auto px-4 sm:px-6 py-3.5 flex items-center justify-between">
            ...
            <div class="flex items-center gap-6">
                <a href="index.html" class="text-slate-600 hover:text-blue-600 font-bold text-xs uppercase tracking-widest flex items-center gap-1.5">
                    <i data-lucide="home" class="w-4 h-4"></i> <span>Home</span>
                </a>
                ${user ? `<button id="nav-logout-btn" class="bg-slate-100 text-slate-700 px-4 py-2 rounded-xl font-bold text-xs">Logout</button>` : `<a href="Login.html" class="bg-slate-900 text-white px-5 py-2.5 rounded-xl font-bold text-xs">Admin</a>`}
            </div>
        </div>
    `;
    return nav;
...
export function renderMarksheet(data, meta) {
    ...
    return `
        <div class="a4-container p-6 sm:p-10 border-4 border-double border-slate-800 rounded-[2.5rem] w-full max-w-4xl mx-auto bg-white shadow-2xl overflow-hidden flex flex-col justify-between h-full">
            <div class="flex-grow">
            ...
            <div>
                <div class="grid grid-cols-2 items-end pt-6 border-t-2 border-slate-800 gap-12 sm:gap-48">
                    <div class="text-center group">
                        <img src="https://i.ibb.co.com/HDqfKG6K/Seal-school.png" class="h-20 sm:h-32 mx-auto object-contain">
                    </div>
                    <div class="text-center flex flex-col items-center">
                        <img src="https://i.ibb.co.com/1C0fss2/Tarikul-sign.png" class="h-12 sm:h-20 object-contain mb-1">
                        <div class="border-b-2 border-slate-800 mb-1 w-full max-w-[150px] sm:max-w-[240px]"></div>
