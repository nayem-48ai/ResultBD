                        ...
                        <tbody class="text-[13px]">
                            ${subjectList.map(([s, m], idx) => `
                                <tr class="${idx % 2 === 0 ? 'bg-white' : 'bg-slate-50/50'}">
                                    <td class="p-2 border-r border-b border-slate-200 font-semibold text-slate-700 italic truncate">${s}</td>
            ...
            <div>
                <div class="grid grid-cols-2 items-end pt-6 border-t-2 border-slate-800 gap-48">
                    ...
                    <div class="text-center flex flex-col items-center">
                        <img src="https://i.ibb.co.com/1C0fss2/Tarikul-sign.png" class="h-16 object-contain mb-1 opacity-90">
                ...
                <p class="mt-6 text-center text-[9px] text-slate-400 font-bold uppercase tracking-[0.3em]">* VALID ONLY WITH OFFICIAL INSTITUTIONAL HOLOGRAM *</p>
            </div>
        </div>
    `;
}
